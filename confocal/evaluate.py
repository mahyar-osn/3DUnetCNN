...
def main():
    header = ("Membrane", "Cell")
    # masking_functions = (get_background_mask, get_membrane_mask, get_cell_mask)
    masking_functions = (get_membrane_mask, get_cell_mask)
    rows = list()
    subject_ids = list()
    ...
    df.to_csv("./prediction/cell_score.csv")
