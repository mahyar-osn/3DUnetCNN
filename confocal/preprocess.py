...
def get_background_mask(in_folder, out_file, truth_name="53_2nd_Ori_SBack_label"):
    """
...
def convert_brats_folder(in_folder, out_folder, truth_name="53_2nd_label",
                         no_bias_correction_modalities=None):
    for name in config["training_modalities"]:
    ...
    check_origin(out_file, get_image(in_folder, config["training_modalities"][0]))


# def convert_brats_data(brats_folder, out_folder, overwrite=False, no_bias_correction_modalities=("flair",)):
def convert_brats_data(brats_folder, out_folder, overwrite=True, no_bias_correction_modalities=None):
    """
