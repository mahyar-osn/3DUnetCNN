...
# config["labels"] = (0, 1, 2)  # the label numbers on the input image
config["n_labels"] = len(config["labels"])
config["all_modalities"] = ["t1", "t1Gd", "flair", "t2"]
# config["all_modalities"] = ["53_2nd_Ori_SBack_Ch1", "53_2nd_Ori_SBack_Ch2", "53_2nd_Ori_SBack_Ch3"]
...
config["model_file"] = os.path.abspath("cell_segmentation_model.h5")
